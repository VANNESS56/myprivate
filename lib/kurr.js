...
GITHUB OWNER:https://github.com/VANNESS56
YOUTUBE OWNER:https://youtube.com/c/VANNESSTZY
sendButLocation(from, `${menu}`, "*_© VANNESS STORE ゑ_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`store`,buttonText:{displayText:'VANNESS STORE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
