...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© VANNESS STORE ゑ v.3.0_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `VANNESS BOTZ : ${waktu(runtime)}`, //Kasih namalu
                            orderTitle: `VANNESS TZY v.3.0`,
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
        ...
        const sendWebp = async(from, url) => {
	        ...
	        const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + `ORG:Developer Vanness Storeゑ v.3.0\n` + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
...
if(budy.includes('Vanness')){
kurr.sendMessage(from, "hayo ngomongin owner gua ya", text)
kurr.sendMessage("6281266375722@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('vanes')){
kurr.sendMessage(from, "hayo ngomongin owner gua ya", text)
kurr.sendMessage("6281266375722@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
...
if(budy.includes('vannes')){
kurr.sendMessage(from, "hayo ngomongin owner gua ya", text)
kurr.sendMessage("6281266375722@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('Assalamualaikum')){
cpref = `Hay Saya VANNESS BOTZ 〽️ Whatsapp Ketik .menu Untuk Mengakses`
reply(cpref)
}
if(budy.includes('assalamualaikum')){
cpref = `Hay Saya VANNESS BOTZ 〽️ Whatsapp Ketik .menu Untuk Mengakses`
...
kurr.updatePresence(from, Presence.recording)
   ...
   const sotoy = [
		...
		//runtime berjalan
           runi = process.uptime() 
           kurr.setStatus(`VANNESS BOTZ || ${latensyi.toFixed(4)} DETIK`).catch((_)=>_);
...
└───────⭓ 
 `
 jck = "𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗕𝘆 vannessstore.xyz"
 butkon1 = [
...
│⭔𝘽𝙊𝙏 𝙉𝘼𝙈𝙀 : VANNESS BOTZ〽️
│⭔𝙊𝙒𝙉𝙀𝙍 𝙉𝘼𝙈𝙀 : VANNESS STORE
...
case 'sm':
 ...
 rows: [
                       ...
                       "rowId": `${prefix}buypremium`
                           ...
                           {                         
                              "title": "️Jasa Run Bot️",
                              "description" :"Menampilkan List Menu Jasa Run Bot",
...
break
 ...
 rows: [
                          {
                              "title": "INFOBOT",
                              "description": '〽️INI UNTUK MELIHAT INFORMASI BOT〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "JADIBOT",
                              "description": '〽️INI UNTUK JADIBOT〽️',
                              "rowId": ""
                            
                           },
                          {
                              "title": "OWNERMENU",
                              "description": '〽️INI MENU KHUSUS PEMILIK BOT〽️',
                              "rowId": ""
                            
                           },
                          {
                              "title": "GROUPMENU",
                              "description": '〽️INI MENU KHUSUS GROUP〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "VIPMENU",
                              "description": '〽️KHUSUS MEMBER VIP〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "CONVERTMENU",
                              "description": '〽️INI MENU CONVERTER〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "DOWNLOADMENU",
                              "description": '〽️INI MENU DOWNLOADER〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "ANONYMOUSMENU",
                              "description": '〽️INI MENU  CARI TEMAN〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "LOGOMENU",
                              "description": '〽️️INI MENU BIKIN LOGO〽️️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "RANDOMVIDEOMENU",
                              "description": '〽️INI MENU RANDOM VIDEO〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "RANDOMTEXTMENU",
                              "description": '〽️INI MENU RANDOM TEXT〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "RANDOMIMAGEMENU",
                              "description": '〽️INI MENU RANDOM IMAGE〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "RANDOMIMAGE",
                              "description": '〽️INI MENU RANDOM IMAGE V2〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "ASUPANMENU",
                              "description": '〽️INI MENU ASUPAN〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "CECANMENU",
                              "description": '〽️INI MENU CECAN〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "SEWABOT",
                              "description": '〽️INI UNTUK SEWABOT〽️',
                              "rowId": ""
                            
                           },
                           {
                              "title": "SPEED",
                              "description": '〽️NII UNTUK SPEED〽️',
                              "rowId": ""
                           },
                           {
                              "title": "STOREMENU",
                              "description": '💎INI UNTUK MENAMPILKAN STORE MENU💎',
                              "rowId": ""
                           },
                           {
                              "title": "TQTO",
                              "description": '🏅INI UNTUK MENAMPILKAN TQTO🏅️',
                              "rowId": ""
...
"displayName": `Developer Vanness Botz ゑ`,
"contacts": ini_list 
...
case 'attp':
					...
					if (!c) return reply(`Teks Nya Mana Kak?\nContoh :\n${prefix}${command} Vanness Store ゑ`)
...
case 'stiker': //by Guntur P
     ...
     if (!isPremium) return reply(`SORRY FITUR INI HANYA UNTUK\nMEMBER VIP\nJOIN VIP https://wa.link/1322t0`)
              ...
              buttonsMessage = {footerText:'VANNESS BOTZ〽️', imageMessage: imageMsg,
...
if (!isPremium) return reply(`SORRY FITUR INI HANYA UNTUK\nMEMBER VIP\nJOIN VIP https://wa.link/1322t0`)
            ...
            case 'wallml':
              ...
              buttonsMessage = {footerText:'𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗕𝘆 vannessstore.xyz', imageMessage: imageMsg,
...
case 'next': case 'leave': case "stop": {
  ...
  if (other) await reply(`𝙔𝙖𝙝𝙖𝙝𝙖 𝙆𝙖𝙨𝙞𝙖𝙣 𝘿𝙞 𝙎𝙠𝙞𝙥 𝘽𝙩𝙬 𝙎𝙪𝙗𝙧𝙚𝙠 VANNESS TZY〽️`);
...
Chat No Tersebut
 `
 uhhk = "𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗕𝘆 vannessstore.xyz"
...
kurr.sendMessage(from, {url: `${pint[Math.floor(Math.random() * pint.length)]}`}, image, {quoted: mek, thumbnail: Buffer.alloc(0), caption: "Subrek Https://youtube.com/VANNESSTZY"})
break
case 'opengrup':
if (!isGroup) return reply(mess.only.group)
if (!isGroupAdmins) return reply(`Khusus Admin Om`)
...
break
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: "Developer  BOTZ ゑ",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logo.jpg'),sourceUrl:"https://wa.me/p/6288286868638/6281220670449"}}})
	}
    }
    }
    }
